...
cWarn =  [{ sprintf('Error in %s:', St(I+1,1).name), ...
    ...
    {'', 'If this is an unexpected error message it may be a bug. Please report bugs at https://github.com/pmknutsen/whiskertracker/issues and include a copy of the entire error message along with a description of what you attempted to do, and how.'}];
